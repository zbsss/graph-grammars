...
_graph_vertices_id_counter - vertices counter which assigns ID to each vertex
...
def _resolve_vertices_coordinates_for_square(square):
    ...
    _graph_vertices_id_counter += 1
    square.vertices.append(
        Vertex(x_upper_left_vertex + 1, y_upper_left_vertex, _graph_vertices_id_counter, VertexLabel.UNDEFINED))
    _graph_vertices_id_counter += 1
    square.vertices.append(
        Vertex(x_upper_left_vertex, y_upper_left_vertex - 1, _graph_vertices_id_counter, VertexLabel.UNDEFINED))
    _graph_vertices_id_counter += 1
    square.vertices.append(Vertex(x_upper_left_vertex + 1, y_upper_left_vertex - 1, _graph_vertices_id_counter,
                                    VertexLabel.UNDEFINED))
    _graph_vertices_id_counter += 1
    square.vertices.append(Vertex(x_upper_left_vertex + 0.5, y_upper_left_vertex - 0.5, _graph_vertices_id_counter,
                                    VertexLabel.UNDEFINED))
    _graph_vertices_id_counter += 1
